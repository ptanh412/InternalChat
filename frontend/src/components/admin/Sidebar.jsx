...
const Sidebar = ({ currentPath, collapsed }) => {
    ...
    return (
        <div className={`h-screen space-y-10 bg-white dark:bg-neutral-800 shadow-xl transition-all duration-300 ${collapsed ? 'px-2' : 'px-5'} overflow-hidden`}>
            ...
            <div className="space-y-4">
                {!collapsed && <h1 className="text-neutral-400 font-semibold text-xs">MENU</h1>}
                    ...
                    {navItems.map((item) => (
                        <Link key={item.path} to={item.path}
                            ...
                            ${currentPath === item.path ? 
                                ...
                                : 'hover:bg-blue-100 hover:text-blue-500 dark:hover:bg-blue-900/50 dark:text-neutral-200 dark:hover:text-blue-300'
                                }`}>
