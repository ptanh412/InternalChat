			...
			<div className="w-full max-w-md mx-auto shadow-2xl rounded-lg bg-white">
				...
				{tab === 0 ? (
					...
					<form className="p-6" onSubmit={handleRegister}>
						...
						<div className="flex flex-col space-y-3 my-3">
							<label className="text-xl font-semibold text-black">Department</label>
							<div className="w-full relative">
								<MdWork className="absolute top-3.5 left-2 h-4 w-4 bottom-0 text-2xl text-gray-500" />
								<input
									type="text"
						...
						<div className="flex flex-col space-y-3 my-3">
							<label className="text-xl font-semibold text-black">Position</label>
							<div className="w-full relative">
								<MdWork className="absolute top-3.5 left-2 h-4 w-4 bottom-0 text-2xl text-gray-500" />
								<input
									type="text"
						...
						<div className="flex flex-col space-y-3 my-3">
							<label className="text-xl font-semibold text-black">Phone Number</label>
							<div className="w-full relative">
								<MdPhone className="absolute top-3.5 left-2 h-4 w-4 bottom-0 text-2xl text-gray-500" />
								<input
									type="text"
